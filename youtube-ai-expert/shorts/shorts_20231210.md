...
[INSTRUCTION]
Please create a Youtube short script to gain at least 10000 subscribers whose subject is useful recent information about "How to set the best New Year's Resolution?". Explain the best way of thinking and set the new year's resolution. Please use simple word as possible as you can so that even 5 years old child can understand.
